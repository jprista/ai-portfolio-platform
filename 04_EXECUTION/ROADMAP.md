...
| 2026-07-03 | Ambos | **Infraestrutura M1 iniciada:** GitHub (repo privado, push completo) · Supabase provisionado, **2 migrações aplicadas** (25 tabelas), **prova de RLS e imutabilidade no banco real** · Clerk validado · CI no GitHub Actions (goldens + contratos + varredura de segredos) | **Feito** — pendência: projeto Supabase está em us-east-2 (Ohio); recriar em sa-east-1 (São Paulo) antes de dados reais |
