...
| 2026-07-03 | Ambos | **Infraestrutura M1 iniciada:** GitHub (repo privado, push completo) · Supabase provisionado, **2 migrações aplicadas** (25 tabelas), **prova de RLS e imutabilidade no banco real** · Clerk validado · CI no GitHub Actions (goldens + contratos + varredura de segredos) | **Feito** — ~~pendência de região~~ **resolvida em 2026-07-03**: projeto recriado em **sa-east-1 (São Paulo)**, migrações re-aplicadas, RLS e imutabilidade re-provadas |
